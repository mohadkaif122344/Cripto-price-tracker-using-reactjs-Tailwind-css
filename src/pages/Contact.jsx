const Contact = () => {
  ...
  return (
    <div className="min-h-[80vh] p-6 pt-28 flex flex-col items-center bg-gray-900">
      <h1 className="text-4xl md:text-4xl font-extrabold text-center mb-10 text-white underline underline-offset-4 decoration-white opacity-0 animate-fadeIn hover:text-blue-500">
        Contact Us
      </h1>
      <form
        onSubmit={handleSubmit}
        className="w-full max-w-xl bg-gray-800 text-white p-10 rounded-2xl shadow-2xl border border-gray-600 transition duration-300 hover:shadow-blue-500/40"
      >
        <input
          type="hidden"
          name="access_key"
