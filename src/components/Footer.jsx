...
const Footer = () => {
  return (
    <footer
      className="bg-gray-700 text-white text-center p-6 mt-8 border-t-4 border-gray-600 
    ...
    >
      ...
      <p className="mb-2 text-lg md:text-xl text-gray-200">
        Track live cryptocurrency prices, search your favorite coins, and switch
        currencies easily.
      </p>
      ...
      <div className="mt-4 pt-3">
        ...
        <p className="text-md md:text-lg text-gray-300">
          &copy; 2025 <span className="font-bold">CryptoTracker</span>. All
          rights reserved.
        </p>
      </div>
    </footer>
