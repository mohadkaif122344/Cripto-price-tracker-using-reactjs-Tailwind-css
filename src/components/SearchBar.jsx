...
const SearchBar = () => {
  ...
  return (
    <div className="flex items-center justify-center  my-10" ref={containerRef}>
      <div className="flex md:flex-row w-full max-w-[700px] gap-4">
        <div className="relative flex-1 w-full">
          <input
            ...
            className="pl-6 pr-12 py-4 w-full rounded-full border border-gray-300 bg-gray-900 text-white  placeholder-gray-400
